...
@section('content')
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="mb-8 flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold mb-2 text-gray-800">Tambah Pengguna Baru</h1>
        ...
        <div class="bg-white shadow-sm rounded-md overflow-hidden p-6">
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <h2 class="text-xl font-semibold mb-4 text-gray-800 border-b pb-2">Informasi Profil (Opsional)</h2>

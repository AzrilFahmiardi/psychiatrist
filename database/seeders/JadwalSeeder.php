...
class JadwalSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $startDate = Carbon::parse('2024-12-17'); // Ubah dengan tanggal yang diinginkan
        ...
        DB::table('jadwals')->insert([
            ...
            ['waktu' => $startDate->copy()->addHour(1), 'psikolog_id' => $psikologId, 'created_at' => now(), 'updated_at' => now()],
            ['waktu' => $startDate->copy()->addHour(2), 'psikolog_id' => $psikologId, 'created_at' => now(), 'updated_at' => now()],
            ['waktu' => $startDate->copy()->addHour(3), 'psikolog_id' => $psikologId, 'created_at' => now(), 'updated_at' => now()],
            ['waktu' => $startDate->copy()->addHour(4), 'psikolog_id' => $psikologId, 'created_at' => now(), 'updated_at' => now()],
